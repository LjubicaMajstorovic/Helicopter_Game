...
public class Field4 extends Group implements Field{
    ...
    public Field4(Helicopter helicopter){
        ...
        waters = new Water[]{
                ...
                new Water(new Transform[]{new Translate(WINDOW_WIDTH/3.2, 0), new Rotate(90)}),
